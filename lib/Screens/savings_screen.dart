                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: const TextStyle(fontSize: 12, color: Color(0xFF6B786F)),
                    ),
                      ...
                      builder: (context, summarySnapshot) {
                        if (summarySnapshot.connectionState == ConnectionState.waiting) {
                          return const Padding(
                            ...
                            child: LinearProgressIndicator(color: Color(0xFF1B8A4A)),
                          );
                        }

                        if (summarySnapshot.hasError || !summarySnapshot.hasData) {
                          return const Text(
                            'No cost entries logged yet for this bike.',
                            style: TextStyle(fontSize: 12, color: Color(0xFF6B786F)),
                          );
                        }
                        ...
                        return Column(
                          children: [
                            _SavingsRow(
                              ...
                              value: 'KES ${_formatKes(summary.totalPetrolEquivalentKes)}',
                            ),
                            const SizedBox(height: 4),
                            _SavingsRow(
                              label: 'Actual cost paid',
                              value: 'KES ${_formatKes(summary.totalActualCostKes)}',
                            ),
                            const Divider(height: 20, color: Color(0xFFE2E8E4)),
                            _SavingsRow(
                              label: 'Total saved',
                              value: 'KES ${_formatKes(summary.totalSavingsKes)}',
                              isHighlighted: true,
                            ),
                          ],
                        );
      ...
      children: [
        ...
        Text(
          ...
          style: TextStyle(
            ...
            fontWeight: FontWeight.w600,
            color: isHighlighted ? const Color(0xFFB45309) : const Color(0xFF1A2620),
          ),
        ),
      ],
    );
